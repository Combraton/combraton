# Combraton documentation

Read [repository scope](../README.md), then [baseline](architecture/BASELINE.md), [architecture](architecture/ARCHITECTURE.md), [steering](architecture/STEERING.md), and [UI](architecture/UI.md). These current specs are authoritative for this repository; they are not implemented APIs.

- [Development workflow](DEVELOPMENT.md) — ownership, parallel work, reviews and fresh-session recovery.
...
- [Shared baseline](architecture/BASELINE.md) — product ownership and invariants.
